...
4. **Design system node** — Optional; stores source text, Markdown, and images. The Incubator prepares a generated Google DESIGN.md document when needed, then that document is injected into prompts when wired to the Incubator or hypotheses.
