...
2. Explore (ls / find / read) as needed; call **use_skill** before matching milestone work when you still need that skill's text (skills are not files in the sandbox); implement with **write** (new/full rewrite) and **edit** (targeted changes).
