/**
 * Reads **required** system prompts from `prompts/{name}/PROMPT.md` on disk.
 * Missing or invalid frontmatter throws — the designer system prompt must load for agentic runs.
 * (Contrast `skill-discovery.ts`: skills are optional catalog entries; malformed packages are omitted.)
