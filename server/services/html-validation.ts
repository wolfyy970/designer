/**
 * Structural HTML validation for Pi `validate_html` tool (workspace-relative assets, Google Fonts allowlist).
 */
import {
...
/**
 * Run structural checks on HTML source. `hasProjectFile` resolves relative paths from the workspace root.
 */
