...
| `/api/design-system/extract`    | POST   | Generate a linted Google DESIGN.md document from design-system text and/or images (Pi task agent; SSE; final `task_result` with Markdown + lint summary)                                           | SSE stream                 |
