...
| Design System        | Processing | Self-contained design-system source. Supports multiple instances (e.g., Material Design vs custom tokens). Text, Markdown sources, and images stay in node data; the Incubator prepares a linted Google DESIGN.md document for downstream prompts when connected sources are missing or stale.                                                                       |
