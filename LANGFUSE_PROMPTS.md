...
In **Langfuse** and (in **dev** only) **Prompt Studio**, templates are keyed by **kebab-case** identifiers (stable API names). This page maps each name to **what it’s for** and **when the app uses it**.
