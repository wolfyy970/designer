...
| [DESIGN_SYSTEM.md](DESIGN_SYSTEM.md)             | SPA design tokens (Indigo palette, light + dark): atoms, typography triad, file-role colors (`src/index.css`). Visual reference: [AutoDesigner Indigo Reference.html](AutoDesigner%20Indigo%20Reference.html)                                                                                                        |
